...
urlpatterns = [
    ...
    # path('myorders_products', views.user_order_products, name='user_order_products'),
    # path('orderdetail/<int:id>', views.user_order_detail, name='user_order_detail'),
    # path('orderdetail_product/<int:id>/<int:oid>', views.user_order_detail_product, name='user_order_detail_product'),
